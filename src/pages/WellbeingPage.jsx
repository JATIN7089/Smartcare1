  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="bg-gradient-to-r from-teal-800 via-teal-700 to-sky-800 rounded-3xl p-6 sm:p-10 text-white shadow-xl">
        <span className="text-xs font-black uppercase tracking-widest bg-white/20 px-3 py-1 rounded-full">{t('wb_title')}</span>
        <h1 className="text-3xl sm:text-4xl font-black mt-3">{t('wb_sub')}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border-2 border-teal-200 shadow-sm hover:shadow-md transition flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div>
              <span className="text-[11px] font-bold text-teal-800 bg-teal-50 px-2.5 py-0.5 rounded-full border border-teal-200">{t('wb_core')}</span>
              <h3 className="text-xl font-black text-slate-900 mt-2">{t('wb_pacer')}</h3>
              <p className="text-xs sm:text-sm text-slate-600 mt-1 leading-relaxed">{t('wb_pacer_desc')}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 border-2 border-indigo-200 shadow-sm hover:shadow-md transition flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div>
              <span className="text-[11px] font-bold text-indigo-800 bg-indigo-50 px-2.5 py-0.5 rounded-full border border-indigo-200">{t('wb_sensory')}</span>
              <h3 className="text-xl font-black text-slate-900 mt-2">{t('wb_ground')}</h3>
              <p className="text-xs sm:text-sm text-slate-600 mt-1 leading-relaxed">{t('wb_ground_desc')}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 border-2 border-sky-200 shadow-sm hover:shadow-md transition flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div>
              <span className="text-[11px] font-bold text-sky-800 bg-sky-50 px-2.5 py-0.5 rounded-full border border-sky-200">{t('wb_wearable')}</span>
              <h3 className="text-xl font-black text-slate-900 mt-2">{t('wb_monitor')}</h3>
              <p className="text-xs sm:text-sm text-slate-600 mt-1 leading-relaxed">{t('wb_sim_desc')}</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
        <h3 className="font-bold text-lg text-slate-900">{t('wb_sessions')}</h3>
        {breathingSessions.length > 0 ? (
          ...
          <p className="text-xs text-slate-500 py-4">{t('wb_no_sessions')}</p>
        )}
      </div>
